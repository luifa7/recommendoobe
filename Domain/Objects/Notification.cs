...
namespace Domain.Objects
{
    public class Notification
    {
        ...
        private static Dictionary<string, string> _notificationTexts = new()
        {
        ...
        public static Notification Create(string userDId, string type,
            bool wasOpen, string relatedDId)
        {
            var DId = Guid.NewGuid().ToString();

            return new Notification(
                DId, userDId, type,
                _notificationTexts[type],
                wasOpen, relatedDId);
        }
    }
}
